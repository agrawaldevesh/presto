        ...
        implements Connector
{
    ...
    public PinotConnector(LifeCycleManager lifeCycleManager, PinotMetadata metadata, PinotSplitManager splitManager, PinotPageSourceProvider pageSourceProvider,
            PinotNodePartitioningProvider partitioningProvider, PinotSessionProperties pinotSessionProperties, PinotConnectorPlanOptimizer planOptimizer)
    {
        ...
        this.planOptimizer = requireNonNull(planOptimizer, "plan optimizer");
    }
