        ...
        implements ConnectorPageSource
{
    ...
    private void fetchPinotData()
    {
        ...
        try {
            Map<ServerInstance, DataTable> dataTableMap = pinotQueryClient.queryPinotServerForDataTable(split.getSegmentPql().get(), split.getSegmentHost().get(), split.getSegments(), PinotSessionProperties.getConnectionTimeout(session), PinotSessionProperties.isIgnoreEmptyResponses(session), PinotSessionProperties.getPinotRetryCount(session));
